...
const ChartCard: React.FC<ChartCardProps> = ({ title, category_spent, total_amount, totalLabel }) => {
  return (
      ...
      <div className={styles.content}>
        <div className={styles.chartContainer}>
          ...
          <div className={styles.chartInfo}>
            <p className={styles.chartInfoLabel}>{totalLabel}</p>
            <p className={styles.chartInfoValue}>{formatMoney(total_amount)}</p>
          </div>
        </div>
